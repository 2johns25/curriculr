<div class="sidebox_container">
        ...
        <ul class="topic_box_list">
            <li><a class="topic_title">Introduction to the OSI Network Model</a></li>
            <ul class="topic_box_subtopic_list">
                <li><a class="content_sub_topic content_active_link">Layer 1: Physical layer</a></li>
                    <ul class="topic_box_sub_subtopic_list">
                        <li><a class="content_sub_topic ">Wired media</a></li>
