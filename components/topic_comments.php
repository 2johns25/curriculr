<div class="topic_comments_container">
            ...
            <div class="new_comment_form_wrapper">
                <div class="new_comment_input_wrapper">
                    <div class="new_comment_placeholder_container">
                        <div class="new_comment_input_placeholder">Write a comment...</div> <!-- New comment_input_placeholder -->
                        <div class="new_comment_input" contenteditable="true"></div> <!-- New comment input-->
                    </div> <!-- New comment placeholder container -->
                </div> <!-- New comment input wrapper -->
                <div class="new_comment_form_actions_container">
                    <div class="rectangle_fill_button new_comment_cancel_button">Cancel</div>
                    <div class="cta_button post_button">Post</div>
                </div> <!-- New comment form actions container-->
            </div> <!-- New comment form wrapper -->
        </div> <!-- New comment section -->
    </div> <!-- New comment section -->
    ...
    </div> <!-- Previous_comment_section -->
</div> <!-- Topic comments container -->